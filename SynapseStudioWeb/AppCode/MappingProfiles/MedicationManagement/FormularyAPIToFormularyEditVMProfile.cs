    ...
    public class FormularyAPIToFormularyEditVMProfile : Profile
    {
        public FormularyAPIToFormularyEditVMProfile()
        {
            ...
            CreateMap<FormularyExcipientAPIModel, FormularyExcipientModel>()
                .ForMember(dest => dest.Ingredient, opt => opt.MapFrom(src => ConvertStringFromAPIToCodeNameModelWithDefaults(src.IngredientCd, TerminologyConstants.DMD_DATA_SOURCE, src.IngredientCd)))
                .ForMember(dest => dest.Strength, opt => opt.MapFrom(src => src.Strength))
                .ForMember(dest => dest.StrengthUnit, opt => opt.MapFrom(src => ConvertStringFromAPIToCodeNameModelWithDefaults(src.StrengthUnitCd, TerminologyConstants.DMD_DATA_SOURCE, src.StrengthUnitCd)));


            CreateMap<FormularyIngredientAPIModel, FormularyIngredientModel>()
                .ForMember(dest => dest.Ingredient, opt => opt.MapFrom(src => ConvertStringFromAPIToCodeNameModelWithDefaults(src.IngredientCd, TerminologyConstants.DMD_DATA_SOURCE, null)))
                .ForMember(dest => dest.BasisOfPharmaceuticalStrength, opt => opt.MapFrom((src) => src.BasisOfPharmaceuticalStrengthCd))
                .ForMember(dest => dest.StrengthValueDenominatorUnit, opt => opt.MapFrom(src => ConvertStringFromAPIToCodeNameModelWithDefaults(src.StrengthValueDenominatorUnitCd, TerminologyConstants.DMD_DATA_SOURCE, null)))
                .ForMember(dest => dest.StrengthValueNumeratorUnit, opt => opt.MapFrom(src => ConvertStringFromAPIToCodeNameModelWithDefaults(src.StrengthValueNumeratorUnitCd, TerminologyConstants.DMD_DATA_SOURCE, null)))
