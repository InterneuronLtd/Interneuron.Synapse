...
+function ($) {
	...
	$('input[type=checkbox][data-toggle^=toggle]').off('click', toggleClick);
	$('input[type=checkbox][data-toggle^=toggle]').click(toggleClick);

	//$(document).on('click.bs.toggle', 'div[data-toggle^=toggle]', toggleClick);
}(jQuery);