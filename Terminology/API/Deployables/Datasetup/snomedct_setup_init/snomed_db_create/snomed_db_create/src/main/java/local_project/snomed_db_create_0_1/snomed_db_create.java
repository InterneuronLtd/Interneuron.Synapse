...
package local_project.snomed_db_create_0_1;
...
/**
 * Job: snomed_db_create Purpose: snomed_db_create<br>
 * Description: snomed_db_create <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class snomed_db_create implements TalendJob {
...
public String getSnomed_uk_release(){
	...
	private final String jobName = "snomed_db_create";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				snomed_db_create.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(snomed_db_create.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
String valueData = context.snomed_db_psql_path+"psql -a -f "+ context.snomed_db_script_path +"terminology_snomed_createtables.sql \"host="+ context.snomed_db_host +" port="+ context.snomed_db_port +" dbname="+ context.snomed_db_name +" user="+ context.snomed_db_user +" password="+ context.snomed_db_pwd_string +"\"";
...
final Process ps_tSystem_1 = runtime_tSystem_1.exec( context.snomed_db_psql_path+"psql -a -f "+ context.snomed_db_script_path +"/terminology_snomed_createtables.sql -a -f "+ context.snomed_db_script_path +"/lookup_semantics_tag.sql \"host="+ context.snomed_db_host +" port="+ context.snomed_db_port +" dbname="+ context.snomed_db_name +" user="+ context.snomed_db_user +" password="+ context.snomed_db_pwd_string +"\"" ,env_tSystem_1);
 ...
 */
    ...
    public static void main(String[] args){
        final snomed_db_create snomed_db_createClass = new snomed_db_create();

        int exitCode = snomed_db_createClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = snomed_db_create.class.getClassLoader().getResourceAsStream("local_project/snomed_db_create_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = snomed_db_create.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : snomed_db_create");
        }
...
/************************************************************************************************
 *     40719 characters generated by Talend Open Studio for Data Integration 
 *     on the 7 December 2020 at 6:24:11 PM IST
 ************************************************************************************************/