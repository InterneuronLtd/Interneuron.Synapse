...
package local_project.dmd_db_views_udfs_0_1;
...
/**
 * Job: dmd_db_views_udfs Purpose: dmd_db_views_udfs<br>
 * Description: dmd_db_views_udfs <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class dmd_db_views_udfs implements TalendJob {
...
public String getDmd_file_path(){
	...
	private final String jobName = "dmd_db_views_udfs";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				dmd_db_views_udfs.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(dmd_db_views_udfs.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
final Process ps_tSystem_1 = runtime_tSystem_1.exec( context.dmd_db_psql_path+"psql -a -f "+ context.dmd_db_script_path +"/terminology_dmd_matviews.sql -f "+ context.dmd_db_script_path +"/terminology_dmd_udfs.sql \"host="+ context.dmd_db_host +" port="+ context.dmd_db_port +" dbname="+ context.dmd_db_name +" user="+ context.dmd_db_user +" password="+ context.dmd_db_pwd_string +"\"" ,env_tSystem_1);
 ...
 */
    ...
    public static void main(String[] args){
        final dmd_db_views_udfs dmd_db_views_udfsClass = new dmd_db_views_udfs();

        int exitCode = dmd_db_views_udfsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dmd_db_views_udfs.class.getClassLoader().getResourceAsStream("local_project/dmd_db_views_udfs_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dmd_db_views_udfs.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dmd_db_views_udfs");
        }
...
/************************************************************************************************
 *     33289 characters generated by Talend Open Studio for Data Integration 
 *     on the 12 January 2021 at 1:06:05 PM IST
 ************************************************************************************************/