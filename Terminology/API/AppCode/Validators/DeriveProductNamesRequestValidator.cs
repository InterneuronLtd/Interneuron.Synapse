...
{
    public class DeriveProductNamesRequestValidator : ITerminologyValidator
    {
        ...
        private DeriveProductNamesRequest _request;

        public DeriveProductNamesRequestValidator(DeriveProductNamesRequest request)
        {
            _request = request;
