...
{
    public class VMPCreateHandler : BaseCreateHandler
    {
        public VMPCreateHandler(IMapper mapper, FormularyDTO request) : base(mapper, request)
        {
        }

        public override FormularyHeader CreateFormulary()
        {
            var formularyHeader = base.CreateHeader();
            formularyHeader.ProductType = "VMP";
            formularyHeader.ParentProductType = "VTM";
