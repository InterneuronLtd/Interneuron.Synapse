...
{
    public class VMPEditMergeHandler : FormularyMergeHandler
    {
        private IMapper _mapper;

        public VMPEditMergeHandler(IMapper mapper): base(mapper)
        {
            _mapper = mapper;
        }
        ...
        public override FormularyHeader Merge(FormularyHeader existingFormulary, FormularyDTO dto)
        {
            ...
            newFormulary.RecStatusCode = dto.RecStatusCode.IsEmpty() ? existingFormulary.RecStatusCode : dto.RecStatusCode;
