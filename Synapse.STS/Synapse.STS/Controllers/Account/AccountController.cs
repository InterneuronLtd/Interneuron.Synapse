...
namespace Synapse.STS.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        private readonly SignInManager<SynapseUser> _signInManager;
        ...
        public AccountController(
            ...
            SignInManager<SynapseUser> signInManager,
        ...
        public async Task<IActionResult> ExternalLoginCallback()
        {
            ...
            //localSignInProps.ExpiresUtc = DateTimeOffset.UtcNow.AddMinutes(1);
            ...
            //StreamWriter wr = new StreamWriter("principalclaimscallback.txt");
            //foreach (var item in principal.Claims)
            //{
            //    wr.WriteLine(item.Type + "-----" + item.Value);
            //}
            //wr.Close();

            //wr = new StreamWriter("resultclaims.txt");
        ...
        private async Task<(SynapseUser user, string provider, string providerUserId, IEnumerable<Claim> claims)>
            FindUserFromExternalProviderAsync(AuthenticateResult result)
        {
            ...
            //StreamWriter wr = new StreamWriter("adfsclaimscallback.txt", true);

            //foreach (var item in externalUser.Claims)
            //{
            //    wr.WriteLine(item.Type + " ----- " + item.Value);
            //}
