...
define(["require", "exports", "../Enumerations/ElementType", "./SectionElement", "../Enumerations/CssClassNames", "../JSONMap/FieldValue", "../Enumerations/ValidationTypes", "../JSONMap/ValidationResult", "../Enumerations/Comparator", "../Enumerations/CompareDateValues", "../formmodel"], function (require, exports, ElementType_1, SectionElement_1, CssClassNames_1, FieldValue_1, ValidationTypes_1, ValidationResult_1, Comparator_1, CompareDateValues_1, formmodel_1) {
    ...
    var Calendar = /** @class */ (function (_super) {
        ...
        function Calendar(id, defaultValue) {
            ...
            _this.domElement.classList.add("date");
            _this.domElement.classList.add("form-control");
            _this.wrapperElement.appendChild(_this.domElement);
            return _this;
        }
        Calendar.prototype.setDefaultValue = function (value) {
        ...
        Calendar.prototype.getStringDate = function (isoDate) {
        ...
        Calendar.prototype.getValue = function () {
            if (typeof this.domElement.value != undefined && this.domElement.value) {
                var _a = this.domElement.value.split("/"), day = _a[0], month = _a[1], year = _a[2];
                return [new FieldValue_1.FieldValue(year + "-" + month + "-" + day + "T00:00:00", year + "-" + month + "-" + day + "T00:00:00")];
            }
            return [new FieldValue_1.FieldValue("", "")];
        };
        Calendar.prototype.getMarkup = function () {
            var _this = this;
            // *** Comment Start *** 
        ...
        Calendar.prototype.getControlType = function () {
            return ElementType_1.ElementType.Date;
        };
        Calendar.prototype.compareValue = function (comparator, dateComponentLow, compareValueLow, dateComponentHigh, compareValueHigh) {
            ...
            if (inputValue && inputValue != "") {
                ...
                if (dateComponentLow == CompareDateValues_1.CompareDateValues.DAYS) {
                ...
                if (dateComponentHigh != null && dateComponentHigh != undefined) {
                    if (dateComponentHigh == CompareDateValues_1.CompareDateValues.DAYS) {
        ...
        Calendar.prototype.validate = function (type) {
        ...
        //validators
        Calendar.prototype.required = function (rule) {
        ...
        Calendar.prototype.valueCompare = function (rule) {
            var isValid = true;
            if (rule) {
        ...
        //events
        Calendar.prototype.onFocusChange = function () {
            //Required Validation on change
            this.validate();
        };
        Calendar.prototype.onCharChange = function () {
        ...
        Calendar.prototype.setDisplay = function (visibile) {
            if (!visibile) {
                if (this.getDisplay())
                    this.clear();
        ...
        Calendar.prototype.getDisplay = function () {
            return !this.wrapperElement.classList.contains(CssClassNames_1.CssClassNames["d-none"]);
        };
        Calendar.prototype.registerEvent = function (event, callback, el) {
