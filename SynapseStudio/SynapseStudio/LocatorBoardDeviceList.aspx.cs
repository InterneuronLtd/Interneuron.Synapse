...
{
    public partial class LocatorBoardDeviceList : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            this.dgLocatorBoardDevices.DataSource = dt;
            this.dgLocatorBoardDevices.DataBind();
        ...
        {
            Response.Redirect("LocatorBoardDeviceNew.aspx");
        }
    }
}