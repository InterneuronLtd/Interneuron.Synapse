...
<%@ Page Title="Client claims" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ClientClaims.aspx.cs" Inherits="SynapseStudio.ClientClaims" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="page-wrapper">
        ...
        <h3><asp:Label ID="lblH3Client" runat="server"></asp:Label><asp:Label ID="lblH3Claims" runat="server" Text=" claims"></asp:Label></h3>
            ...
            <div class="col-lg-12">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <h3>New client claim</h3>
                        <div class="row">
                            <div class="col-md-12">
                                <asp:Panel ID="pnlType" runat="server" class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <asp:Label ID="lblType" runat="server" CssClass="control-label" for="txtType" Text="* Please enter type for client claim" Font-Bold="true"></asp:Label>
                                            <asp:TextBox ID="txtType" runat="server" CssClass="form-control input-lg" MaxLength="255"></asp:TextBox>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <asp:Panel ID="pnlValue" runat="server" class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <asp:Label ID="lblValue" runat="server" CssClass="control-label" for="txtValue" Text="* Please enter value for client claim" Font-Bold="true"></asp:Label>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <asp:Button ID="btnAddClientClaim" runat="server" CssClass="btn btn-primary pull-right" Text="Add " Width="200" OnClick="btnAddClientClaim_Click" ValidationGroup="validate" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <asp:DataGrid ID="dgClientClaim" runat="server" CssClass="table table-striped table-bordered" AutoGenerateColumns="False" OnItemCommand="dgClientClaim_ItemCommand" OnItemDataBound="dgClientClaim_ItemDataBound">
                                    <Columns>
