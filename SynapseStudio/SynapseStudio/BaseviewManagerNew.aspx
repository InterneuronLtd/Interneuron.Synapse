...
<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BaseviewManagerNew.aspx.cs" Inherits="SynapseStudio.BaseviewManagerNew" %>
            ...
            <div class="col-lg-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-database"></i>&nbsp;New Baseview</h3>
                    </div>
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <asp:Panel ID="fgEntityName" runat="server" class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <asp:Label ID="lblEntityName" runat="server" CssClass="control-label" for="txtEntityName" Text="* Please enter a name for the new baseview" Font-Bold="true"></asp:Label>
                                        </div>
                                        <div class="col-md-6">
                                ...
                                <asp:Panel ID="fgEntityComments" runat="server" class="form-group">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <asp:Label ID="lblEntityComments" runat="server" CssClass="control-label" for="txtEntityName" Text="Enter a description for the new baseview" Font-Bold="true"></asp:Label>
                                        </div>
                                    </div>
                                ...
                                <asp:Panel ID="fgSQL" runat="server" class="form-group">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <asp:Label ID="lblSQL" runat="server" CssClass="control-label" for="txtEntityName" Text="* Enter the SQL statement for the new baseview" Font-Bold="true"></asp:Label>
                                        </div>
                                    </div>

                                    <asp:Label ID="errSQL" runat="server"></asp:Label>
                                    <asp:TextBox ID="txtSQL" runat="server" CssClass="form-control input-lg" TextMode="MultiLine" Rows="20"></asp:TextBox>
                                </asp:Panel>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <asp:Button ID="btnCreateNewEntity" runat="server" CssClass="btn btn-primary pull-right" Text="Create Baseview" Width="200" OnClick="btnCreateNewEntity_Click" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
