...
<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BaseViewNamespaceManager.aspx.cs" Inherits="SynapseStudio.BaseViewNamespaceManager" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-9">
                <h1>
                    <asp:Label ID="lblSummaryType" runat="server" Text="BaseView Namespaces"></asp:Label>
                </h1>
            </div>
            <div class="col-lg-3">
            ...
            <div class="col-lg-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-database"></i>&nbsp;Baseview Namespaces</h3>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <asp:Panel ID="fgLocalNamespaceName" runat="server" class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <asp:Label ID="lblLocalNamespaceName" runat="server" CssClass="control-label" for="txtLocalNamespaceName" Text="* Please enter a name for the new BaseView namespace" Font-Bold="true"></asp:Label>
                                        </div>
                                        <div class="col-md-6">
                                ...
                                <asp:Panel ID="fgLocalNamespaceDescription" runat="server" class="form-group">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <asp:Label ID="lblLocalNamespaceDescription" runat="server" CssClass="control-label" for="txtLocalNamespaceDescription" Text="Enter a description for the new BaseView namespace" Font-Bold="true"></asp:Label>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <asp:DataGrid ID="dgEntities" runat="server" CssClass="table table-striped table-bordered" AutoGenerateColumns="False">
                                    ...
                                    <Columns>
                                        <asp:BoundColumn DataField="baseviewnamespace" HeaderText="Baseview Namespace">
