...
<asp:Content ID="Content3" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function getSelectedAttributes() {
            ...
            var url = "ApplicationListMapping.aspx/GetMappedModules";
            var id = $('#listID').text();
            var data = "{'listId': '" + id + "'}";
            return PostData(url, data)
        ...
        function SaveQuickAttributes(attributeId, displayname, isdefaultmodule) {
            var url = "ApplicationListMapping.aspx/SaveDisplayName";
        ...
        function showDetailModal(item) {
            ...
            $('#ContentPlaceHolder1_txtDisplayName').val(item.listname);
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="page-wrapper">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <asp:Panel ID="fgDisplayName" runat="server" class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    <asp:Label ID="lblDisplayName" runat="server" CssClass="control-label" for="txtDisplayName" Text="List Display Name" Font-Bold="true"></asp:Label>
                                </div>
                            </div>
                            ...
                            <asp:CheckBox ID="isdefaultmodule" Visible="false" CssClass="form-control-" runat="server" />
                             <asp:Label ID="lblisdefault"  Visible="false" runat="server">Default Module</asp:Label>
                        </asp:Panel>
        ...
        <div class="row" style="margin-top: 7px;">
            <div class="col-md-6">
                <h4 style="color: #fff;"> <asp:Label ID="lblapplicationname" runat="server"></asp:Label> List Mapping</h4>
            </div>
            <div class="col-md-6">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="selectContainer">
                    <p style="font-size: 1.8em; font-weight: bold">Selected List</p>
