...
<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BedBoardManagerView.aspx.cs" Inherits="SynapseStudio.BedBoardManagerView" %>
                   ...
                   <%-- <div class="panel-heading">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <asp:Button ID="btnDelete" runat="server" CssClass="btn btn-block btn-danger" Text="Delete Bed Board" OnClick="btnDelete_Click" />
                            </div>
                            <div class="col-md-4">                                
