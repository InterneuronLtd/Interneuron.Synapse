...
<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListOptionCollectionView.aspx.cs" Inherits="SynapseStudio.ListOptionCollectionView" %>
            ...
            <div class="col-lg-12">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <h3>Options (<asp:Label ID="lblOptionsCount" runat="server"></asp:Label>)</h3>
                            </div>
                            <div class="col-md-3">
                                <asp:Button ID="btnNewOption" runat="server" CssClass="btn btn-success pull-right" Text="New Option" Width="200" OnClick="btnNewOption_Click" />
                            </div>
                        </div>
