...
<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListQuestionView.aspx.cs" Inherits="SynapseStudio.ListQuestionView" %>
            ...
            <div class="col-lg-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-question"></i>&nbsp;Question</h3>
                    </div>
                    <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <asp:Panel ID="fgQuestionType" runat="server" class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlQuestionType" runat="server" CssClass="form-control input-lg" AutoPostBack="true" OnSelectedIndexChanged="ddlQuestionType_SelectedIndexChanged" Enabled="true">
                                            </asp:DropDownList>
                                        </asp:Panel>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <asp:Button ID="btnSave" runat="server" CssClass="btn btn-primary pull-right" Text="Save Question" Width="200" OnClick="btnSave_Click" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
