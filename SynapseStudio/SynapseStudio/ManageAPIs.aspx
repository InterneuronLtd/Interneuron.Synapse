...
--%>
<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManageAPIs.aspx.cs" Inherits="SynapseStudio.ManageAPIs" %>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <asp:Panel ID="fgClaimName" runat="server" class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <asp:Label ID="lblClaimName" runat="server" CssClass="control-label" for="txtResourceName" Text="* Please enter a name for the new API" Font-Bold="true"></asp:Label>
                                        </div>
                                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <asp:Panel ID="Panel2" runat="server" class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <span style="color: #c5997a; float: right;"></span>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <span style="font-size: 1.8em;">
                                    ...
                                    API Resources (<asp:Label ID="lblResultCount" runat="server"></asp:Label>)</span>
                            </div>
                        </div>
                        <br />
                        <div class="row">
                            <div class="col-md-12">
                                <asp:DataGrid ID="dgAPIResources" runat="server" CssClass="table table-striped table-bordered" AutoGenerateColumns="False" OnItemCommand="dgAPIResource_ItemCommand">
                                    <Columns>
                                        ...
                                        <asp:HyperLinkColumn DataNavigateUrlField="Id" DataNavigateUrlFormatString="APIScopes.aspx?&action=view&id={0}" Text="View">
