...
{
    public partial class EntityManagerNewLocal : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                BindDropDownList(this.ddlLocalNamespace, sql, "localnamespaceid", "localnamespacename", 1);
        ...
        {
            this.ddlLocalNamespace.SelectedIndex = 0;
            this.ddlLocalNamespace.Enabled = true;
            this.ddlLocalNamespace.Focus();
        ...
        protected void btnCreateNewEntity_Click(object sender, EventArgs e)
        {
            ...
            var paramList = new List<KeyValuePair<string, string>>() {
                ...
                new KeyValuePair<string, string>("p_localnamespaceid", this.ddlLocalNamespace.SelectedValue),
        ...
        {
            Response.Redirect("LocalNamespaceManager.aspx");
        }
    }
}