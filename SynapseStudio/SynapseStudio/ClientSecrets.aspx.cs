...
{
    public partial class ClientSecrets : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                this.dgClientSecret.Columns[0].Visible = false;
        ...
        private void BindEntityGrid()
        {
            try
            {
                ...
                this.dgClientSecret.DataSource = dt;
                this.dgClientSecret.DataBind();
        ...
        protected void btnAddClientSecret_Click(object sender, EventArgs e)
        {
            AddNewClientSecret();
        }
        ...
        protected void dgClientSecret_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            if (e.CommandName == "Remove")
            {
                try
                {
                    ...
                    ClearAttributesForm();
                    this.lblSuccess.Text = "Client secret removed";
                    this.lblSuccess.Visible = true;
        ...
        protected void dgClientSecret_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
