...
<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ApplicationListManager.aspx.cs" Inherits="SynapseStudio.ApplicationListManager" %>
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
                            ...
                            <div class="col-md-12">
                                <asp:DataGrid ID="dgApplication" runat="server" CssClass="table table-striped table-bordered" AutoGenerateColumns="False">
                                    <Columns>
                                        ...
                                        <asp:HyperLinkColumn DataNavigateUrlField="application_id" DataNavigateUrlFormatString="ApplicationListMapping.aspx?&app=view&id={0}" Text="View">
            ...
            <div class="col-lg-6">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-briefcase"></i>&nbsp;Lists</h3>
                    </div>
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <span style="font-size: 1.8em;">
                                    ...
                                    Lists (<asp:Label ID="lbllistCount" runat="server"></asp:Label>)</span>
                            </div>
                        </div>
                        <br />
                        <div class="row">
                            <div class="col-md-12">
                                <asp:DataGrid ID="dglist" runat="server" CssClass="table table-striped table-bordered" AutoGenerateColumns="False">

                                    <Columns>
                                        <asp:BoundColumn DataField="listname" HeaderText="List">
                                            <HeaderStyle Width="30%" />
                                        </asp:BoundColumn>
                                        <asp:BoundColumn DataField="listdescription" HeaderText="Description">
