...
namespace Interneuron.CareRecord.HL7SynapseHandler.Service.Infrastructure
{
    public class AutofacLoaderModule : Autofac.Module
    {
        public AutofacLoaderModule()
        {
        ...
        protected override void Load(ContainerBuilder builder)
        {
            ...
            var exceptCurrentAssemblyModule = assemblies.Except(new[] { typeof(AutofacLoaderModule).Assembly }).ToArray();
