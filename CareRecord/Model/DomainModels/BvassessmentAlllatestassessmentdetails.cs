...
{
    public partial class baseview_BvassessmentAlllatestassessmentdetails : Interneuron.CareRecord.Infrastructure.Domain.EntityBase
    {
        public string AssessmentId { get; set; }
        public string AssessmenttypeId { get; set; }
        public string EncounterId { get; set; }
        public string FormtypeId { get; set; }
        public bool? Isassessmentamended { get; set; }
        ...
        public decimal? Sectiontemplateversionid { get; set; }
        public bool? Isamended { get; set; }
        public decimal? Assessmentversionid { get; set; }
