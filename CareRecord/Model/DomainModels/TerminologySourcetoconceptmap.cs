...
{
    public partial class entitystorematerialised_TerminologySourcetoconceptmap : Interneuron.CareRecord.Infrastructure.Domain.EntityBase
    {
        public string SourcetoconceptmapId { get; set; }
