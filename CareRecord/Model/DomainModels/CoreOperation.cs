...
{
    public partial class entitystorematerialised_CoreOperation : Interneuron.CareRecord.Infrastructure.Domain.EntityBase
    {
        ...
        public string Asagradetext { get; set; }
        public string Asagradecode { get; set; }
