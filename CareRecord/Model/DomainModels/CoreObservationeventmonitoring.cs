...
{
    public partial class entitystorematerialised_CoreObservationeventmonitoring : Interneuron.CareRecord.Infrastructure.Domain.EntityBase
    {
        public string ObservationeventmonitoringId { get; set; }
