...
{
    public partial class baseview_DemoBedboard : Interneuron.CareRecord.Infrastructure.Domain.EntityBase
    {
        ...
        public string Patientsurveyflag { get; set; }
        public string Questionflag { get; set; }
        public string Allergies { get; set; }
        public string Dynamiccss { get; set; }
        public int? Ewsvalue { get; set; }
        public string Ewsbadgeclass { get; set; }
    }
}
