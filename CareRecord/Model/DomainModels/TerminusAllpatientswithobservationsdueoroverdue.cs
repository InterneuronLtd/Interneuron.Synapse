...
{
    public partial class baseview_TerminusAllpatientswithobservationsdueoroverdue : Interneuron.CareRecord.Infrastructure.Domain.EntityBase
    {
        ...
        public string Beddisplaynohtml { get; set; }
        public string Beddisplayhtml5 { get; set; }
        ...
        public string ColPatientNoimage { get; set; }
        public string Issamename { get; set; }
        public string ColConsultant { get; set; }
        public string ColConsultantlocator { get; set; }
        ...
        public string Tcidisplaylist { get; set; }
        public string Tcidisplaylistwithbr { get; set; }
        public DateTime? Lastobservationtime { get; set; }
        public string Lastobservationtimetext { get; set; }
        public decimal? Observationfrequency { get; set; }
        public DateTime? Nextobsduetime { get; set; }
        public string Nextobsduetimetext { get; set; }
        public double? Nextobsdueinhours { get; set; }
        public double? Nextobsdueinminutes { get; set; }
        public string Nextobsduestatus { get; set; }
        public decimal? News2score { get; set; }
    }
}
