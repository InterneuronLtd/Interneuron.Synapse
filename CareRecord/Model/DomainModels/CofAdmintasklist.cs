...
{
    public partial class baseview_CofAdmintasklist : Interneuron.CareRecord.Infrastructure.Domain.EntityBase
    {
        ...
        public DateTime? Tasklastsaveddate { get; set; }
        public string Tasklastsaveddateformatted { get; set; }
        public string Tasklastsavedby { get; set; }
        public string Scheduleappointmentin { get; set; }
        public string Scheduleappointmentintext { get; set; }
    }
}
