...
{
    public partial class entitystorematerialised_CoreAdministermedication : Interneuron.CareRecord.Infrastructure.Domain.EntityBase
    {
        ...
        public string Doseformsize { get; set; }
