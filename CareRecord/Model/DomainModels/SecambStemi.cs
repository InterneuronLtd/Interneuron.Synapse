...
{
    public partial class baseview_SecambStemi : Interneuron.CareRecord.Infrastructure.Domain.EntityBase
    {
        public string SecambCadId { get; set; }
        public DateTime? Cademergencycalltime { get; set; }
        public string Cademergencycalltimeformatted { get; set; }
        public DateTime? Cadproblemidentifiedtime { get; set; }
        public string Cadproblemidentifiedtimeformatted { get; set; }
        public string Cadincidentnumber { get; set; }
        public string Cadstationassignedstation { get; set; }
        public string Cadassignedcallsignletter { get; set; }
        public string Cadassignedcallsignnumber { get; set; }
        public DateTime? Cadassignedambulancedispatchedtime { get; set; }
        public string Cadassignedambulancedispatchedtimeformatted { get; set; }
        public string Cadincidentlocation { get; set; }
        ...
        public string Epcrcadincidentnumber { get; set; }
        ...
        public string Responsebadge { get; set; }
        public string Auditbadge { get; set; }
        public string Stemibadge { get; set; }
        public string Aspirinbadge { get; set; }
        public string Gtnbadge { get; set; }
        public string Clopidogrelbadge { get; set; }
        public string Phtbadge { get; set; }
    }
}
